...
type User struct {
	...
	Email         string                 `protobuf:"bytes,3,opt,name=email,proto3" json:"email,omitempty"` // Unique identifier for the user
...
const file_user_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"user.proto\x12\x17trainticketing.entities\"X\n" +
	"\x04User\x12\x1d\n" +
	"\n" +
	"first_name\x18\x01 \x01(\tR\tfirstName\x12\x1b\n" +
	"\tlast_name\x18\x02 \x01(\tR\blastName\x12\x14\n" +
	"\x05email\x18\x03 \x01(\tR\x05emailB/Z-github.com/talk2sohail/train-ticket-api/protob\x06proto3"
...
var file_user_proto_goTypes = []any{
	(*User)(nil), // 0: trainticketing.entities.User
}
